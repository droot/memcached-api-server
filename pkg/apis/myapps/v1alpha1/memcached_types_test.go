...
import (
    ...
    . "github.com/droot/memcached-api-server/pkg/apis/myapps/v1alpha1"
    . "github.com/droot/memcached-api-server/pkg/client/clientset/versioned/typed/myapps/v1alpha1"
)
